...
public class Constants {
    ...
    */
    ...
    public static final String APP_ID_US_DEV = "aura_0dfc7900-id";
    public static final String APP_SECRET_US_DEV = "aura_0dfc7900-eUo-3Se7R25Z_QLeEiXqYkQDUNA";

    // OEM Dashboard:  https://dashboardField.aylanetworks.com
    // Developer Site: Development on field service is not allowed
    public static final String APP_ID_US_FIELD = "aura_0dfc7900-id";
    public static final String APP_SECRET_US_FIELD = "aura_0dfc7900-eUo-3Se7R25Z_QLeEiXqYkQDUNA";
